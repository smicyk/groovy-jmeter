...
start {
    plan {
        ...
        schedule inline: '''
            rate(0/min) random_arrivals(1 min) rate(10/min)
            random_arrivals(1 min 30 sec) rate(10/min)
            random_arrivals(5 sec) rate(20/min)
            random_arrivals(30 sec) rate(20/min)
            random_arrivals(5 sec) rate(0/min)
        ''', {
