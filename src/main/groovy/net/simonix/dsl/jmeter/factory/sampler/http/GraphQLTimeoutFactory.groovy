...
/**
 * The factory class responsible for building <code>timeout</code> element inside graphql element.
 *
 * <pre>
 * // element structure
 * http (
 ...
 */
@CompileDynamic
final class GraphQLTimeoutFactory extends AbstractTimeoutFactory {

    GraphQLTimeoutFactory() {
