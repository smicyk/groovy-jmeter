...
/**
 * Builds files for HTTP sampler. It is used with conjunction with <code>http</code> elements.
 *
 * <pre>
 * // structure
 * files {
 ...
 */
@CompileDynamic
final class HttpFilesFactory extends FilesFactory {

    HttpFilesFactory() {
        super(DslDefinition.HTTP_FILES)
    }

    void onNodeCompleted( FactoryBuilderSupport builder, Object parent, Object files) {
        if (files instanceof HTTPFileArgs && parent.testElement instanceof HTTPSamplerProxy) {
