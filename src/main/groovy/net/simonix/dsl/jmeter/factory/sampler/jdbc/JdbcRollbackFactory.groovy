...
/**
 * The factory class responsible for building <code>rallback</code> element in the test.
 *
 * <pre>
 * // element structure
 * rollback (
 ...
 */
@CompileDynamic
class JdbcRollbackFactory extends TestElementFactory {

    JdbcRollbackFactory() {
        super(QueryTestElement, DslDefinition.JDBC_ROLLBACK)
    }
