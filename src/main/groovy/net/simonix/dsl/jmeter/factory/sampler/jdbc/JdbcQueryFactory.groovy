...
/**
 * The factory class responsible for building <code>query</code> element in the test.
 *
 * <pre>
 * // element structure
 * query (
 ...
 */
@CompileDynamic
class JdbcQueryFactory extends TestElementFactory {

    JdbcQueryFactory() {
        super(QueryTestElement, DslDefinition.JDBC_QUERY)
    }
    ...
    void updateTestElementProperties(TestElement testElement, Object name, Object value, Map config) {
        ...
        if (prepared) {
            testElement.type = 'Prepared Select Statement'
        } else {
            testElement.type = 'Select Statement'
        }
    ...
    void updateOnComplete(Object parent, Object child) {
        if (parent instanceof AbstractJDBCTestElement && child instanceof QueryTestElement) {
            ...
            if(child.parameters) {
                ...
                type = 'Prepared Select Statement'
            }
