...
/**
 * Builds the single file for test element. It is used with conjunction with <code>http</code> elements.
 *
 * <pre>
 ...
 * @see net.simonix.dsl.jmeter.factory.sampler.http.HttpFilesFactory HttpFilesFacotry
 * @see net.simonix.dsl.jmeter.factory.common.FilesFactory FilesFactory
 */
@CompileDynamic
final class HttpFileFactory extends FileFactory {

    HttpFileFactory() {
        super(DslDefinition.HTTP_FILE)
    }
}
