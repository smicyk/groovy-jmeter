...
/**
 * The factory class responsible for building <code>source</code> element inside graphql element.
 *
 * <pre>
 * // element structure
 * source (
 ...
 */
@CompileDynamic
final class GraphQLSourceFactory extends AbstractSourceFactory {

    GraphQLSourceFactory() {
        super(DslDefinition.GRAPHQL_SOURCE)
    }
