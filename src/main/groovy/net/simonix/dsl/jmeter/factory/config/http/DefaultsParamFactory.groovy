...
/**
 * Builds the single parameter for test element. It is used with conjunction with <code>defaults</code> elements.
 *
 * <pre>
 ...
 */
@CompileDynamic
final class DefaultsParamFactory extends ParamFactory {

    DefaultsParamFactory() {
        super(DslDefinition.DEFAULTS_PARAM)
    }
}
