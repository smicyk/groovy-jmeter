...
/**
 * Helper factory responsible for <code>body</code> test element. It is used to define body of <code>ajp</code> element.
 * <p>
 ...
 */
@CompileDynamic
final class AjpBodyFactory extends BodyFactory {

    AjpBodyFactory() {
        super(DslDefinition.AJP_BODY)
    }

    void updateParentProperties(FactoryBuilderSupport builder, Object parent, Object child) {
        if (child instanceof HTTPArgument && parent instanceof AjpSampler) {
