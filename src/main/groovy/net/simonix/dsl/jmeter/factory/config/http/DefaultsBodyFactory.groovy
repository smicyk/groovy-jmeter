...
/**
 * Helper factory responsible for <code>body</code> test element. It is used to define body of <code>defaults</code> element.
 * <p>
 ...
 */
@CompileDynamic
final class DefaultsBodyFactory extends BodyFactory {

    DefaultsBodyFactory() {
        super(DslDefinition.DEFAULTS_BODY)
    }

    void updateParentProperties(FactoryBuilderSupport builder, Object parent, Object child) {
        if (child instanceof HTTPArgument && parent instanceof ConfigTestElement) {
