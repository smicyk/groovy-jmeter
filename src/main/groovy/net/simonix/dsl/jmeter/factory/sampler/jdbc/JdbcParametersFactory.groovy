...
class JdbcParametersFactory extends TestElementFactory {
    ...
    JdbcParametersFactory() {
        super(ParametersTestElement, DslDefinition.JDBC_PARAMETERS)
    }

    void updateParentProperties(FactoryBuilderSupport builder, Object parent, Object child) {
        if (parent instanceof QueryTestElement && child instanceof ParametersTestElement) {
            QueryTestElement element = parent as QueryTestElement

            element.parameters = child
        }
    }
}
